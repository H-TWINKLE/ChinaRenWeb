...
<title>ChinaRen - 创建密码</title>
</head>
<body>
	<%
		String admins = (String) session.getAttribute("admins");
	%>
	...
	<div class="logini-box" align="left">
		<form class="logini-form" action="" method="post">
			<h3 class="logini-head">
				<i class="fa fa-lg fa-fw fa-user"></i>创建密码
			</h3>
		...
		$.ajax({
			...
			success : function(data) {
				if (data == "false") {
					...
					window.setTimeout("window.location='chinaren-registercollege.jsp'",1000); 
				} else {
					$.notify({
						title : "提示 : ",
						message : data,
