			...
			<div class="page-title hidden-print">
				<div>
					...
					<ul class="breadcrumb side">
						...
						<li>动态管理</li>
						<li class="active"><a href="#">所有动态</a></li>
					</ul>
				</div>
			</div>
			<div class="row">
								...
								<tbody>
									<tr>
										<%
											...
											try {
												list = ManageFactory.getInstance().findAllMess();
										...
										<td><%=CommUtil.getInstance().stampToDate(pe.getDates())%></td>
										<td align="center"><a onclick="update(<%=pe.getM_id()%>)">删除动态</a></td>
									</tr>
									<%
										}
									%>
				...
				$.ajax({
					...
					success : function(data) {
						if (data == "删除成功！") {
							...
							window.setTimeout(
									"window.location='chinaren-managedynamic.jsp'",
									1000);
						} else {
							$.notify({
								title : "提示 : ",
